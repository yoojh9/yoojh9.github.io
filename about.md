...
### Project @ company
#### <b> 1)
#### <b> 2) 해군사관학교 LMS 서비스 개발 </b> @한글과컴퓨터 (2018.04 ~ 2019.02)
- 강의 관리 및 편집 API 개발
...
#### <b> 3) 교육 컨텐츠 유통 플랫폼 '이음' 서비스 개발 </b>  @한글과컴퓨터  (2016.11 ~ 2018.02)
...
#### <b> 4) LG유플러스 - 스팸차단서비스 </b>  @필링크 (2016.06 ~ 2016.10)
...
#### <b> 4) kt엠하우스 - 혜택존 관리자 웹, 사용자 앱 추가 요구사항 개발 </b> @필링크 (2016.05 ~ 2016.06)
- 상품 이미지 등록 기능 추가, 상품 카테고리 순서 변경 가능하도록 추가 개발 및 그 외 수정사항 반영
- (spring framework, java, jsp, ms-sql, tomcat)
<br/><br/>

#### <b> 5) IoT기반 서울대 캠퍼스마이크로그리드 구축 및 실증과제 </b> @필링크 (2015.12 ~ 2016.05)
...
#### <b> 6) LS산전 - 태양광 클라우드 모니터링 시스템 </b> @필링크 (2015.07 ~ 2015.12)
